...
export default function DateStatusDot() {
  ...
  var refreshing = useAppointmentStore(function(s) { return s.refreshing; });
  var source = useAppointmentStore(function(s) { return s.source; });
  var initialized = useAppointmentStore(function(s) { return s.initialized; });

  // Only show spinner on true first load (no data yet). 
  // Silent background refreshes should NOT show spinner.
