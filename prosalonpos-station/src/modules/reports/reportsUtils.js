...
export var PAYMENT_LABELS = { cash: 'Cash', credit: 'Credit Card', gift: 'Gift Card', zelle: 'Zelle' };
export var PAYMENT_COLORS = { cash: '#22C55E', credit: '#38BDF8', gift: '#F59E0B', zelle: '#8B5CF6' };
