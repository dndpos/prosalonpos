...
- `src/modules/appointments/CalendarDayView.jsx` — **714 lines** after C88. Fine for now.
...
### When moving navigation buttons (C88 lesson):
...
Update as needed: SESSION_RULES, FILE_MAP, BUSINESS_LOGIC, PROTECTED_CODE.
