...
export default function LoyaltySettings({ program, onProgramUpdate, saveStatus }) {
  var T = useTheme();
  var _defaultProgram = { active: false, program_type: 'flat', earn_per_dollar: 1, earn_per_visit: null, expiration_months: null, redemption_mode: 'manual', tier_reset: null, show_on_receipt: true };
  ...
  return (
    <div style={{position:'relative'}}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
        <div style={{ fontSize: 15, fontWeight: 600, color: T.text }}>Loyalty settings</div>
        {saveStatus && (
          <div style={{ fontSize: 12, fontWeight: 500, padding: '4px 10px', borderRadius: 4,
            backgroundColor: saveStatus === 'saving' ? 'rgba(59,130,246,0.15)' : saveStatus === 'saved' ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)',
            color: saveStatus === 'saving' ? '#60A5FA' : saveStatus === 'saved' ? '#22C55E' : '#EF4444',
          }}>
