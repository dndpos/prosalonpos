...
export default function CheckoutScreen({ appointmentData, onDone, onCloseTicket, openTickets, nextTicketNumber, catalogLayout, drawerSession, salonSettings, onCashPayment, canProcessPayments, onPrintHold }){
  ...
  // ── Handler functions (extracted to useCheckoutItems.js, C9) ──
  var actions = useCheckoutItems({
    ...
    packageRedemptions, applyPackageToItem: pkgHook.applyPackageToItem, removePackageFromItem: pkgHook.removePackageFromItem,
  ...
  var handleAddItem = actions.handleAddItem;
  var handleAddGiftCard = actions.handleAddGiftCard;
  var handleSellPackage = actions.handleSellPackage;
  var handleSellMembership = actions.handleSellMembership;
  var removeItem = actions.removeItem;
  var handleAddTech = actions.handleAddTech;
  var handleClientSelect = actions.handleClientSelect;
  var startEdit = actions.startEdit;
  var switchToDiscountMode = actions.switchToDiscountMode;
  var confirmEdit = actions.confirmEdit;
  var cancelEdit = actions.cancelEdit;
  var applyEditPreset = actions.applyEditPreset;
  var openDiscount = actions.openDiscount;
  var applyDiscount = actions.applyDiscount;
  var applyDiscountPreset = actions.applyDiscountPreset;
  var removeDiscount = actions.removeDiscount;
  var handlePayAmount = actions.handlePayAmount;
  var removePayment = actions.removePayment;
  var openTip = actions.openTip;
  var applyTipPreset = actions.applyTipPreset;
  var applyTipCustom = actions.applyTipCustom;
  var clearTip = actions.clearTip;
  var handleCombine = actions.handleCombine;
  var buildAndClose = actions.buildAndClose;
  var handleMembershipRenew = actions.handleMembershipRenew;
  var handleMembershipCancel = actions.handleMembershipCancel;
