...
import { setSocketId } from './apiClient';
...
function connectSocket() {
  ...
  script.onload = function() {
    ...
    _socket.on('connect', function() {
      _connected = true;
      console.log('[socket] Connected to server, id:', _socket.id);
      // Tell apiClient our socket ID so API requests include X-Socket-ID header.
      // Server uses this to exclude us from our own broadcast events.
...
export { connectSocket, disconnectSocket, onSocketEvent, offSocketEvent, isSocketConnected, getSocketId, emitSocket };
